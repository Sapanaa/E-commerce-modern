...
CREATE UNIQUE INDEX "product_collections_unique" ON "product_collections" USING btree ("product_id","collection_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "cart_items_cart_variant_unique" ON "cart_items" USING btree ("cart_id","product_variant_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "genders_slug_unique" ON "genders" USING btree ("slug");--> statement-breakpoint
CREATE UNIQUE INDEX "colors_slug_unique" ON "colors" USING btree ("slug");--> statement-breakpoint
CREATE UNIQUE INDEX "sizes_slug_unique" ON "sizes" USING btree ("slug");